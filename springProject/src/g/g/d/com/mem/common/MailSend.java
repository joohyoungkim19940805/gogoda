...
public class MailSend {
	//action
	public void MailSet(String newPw, String member) {
		...
		try {
			...
			// 보낸이
			msg.setFrom(new InternetAddress("solideo226@gmail.com", "mailTest"));	
			...
			InternetAddress to = new InternetAddress(member);	
...
mail.GmailSet("newPw", "String member");*/
