 ...
 * Generated at: 2021-03-10 14:29:19 UTC
...
public final class emotionpage_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setCharacterEncoding("UTF-8"); 
	...
	System.out.println("2==========================================================");
      ...
      out.write("/include/css/emotionpage.css?ver=5\" />\r\n");
      out.write("\r\n");
      ...
      out.write("\t\temo_food(0);\r\n");
      out.write("\t\temo_movie(0);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$('#foodPuls').click(function(){\r\n");
      out.write("\t\t\tvar foodCount=$(\"td[name=foodtag]\").length;\r\n");
      out.write("\t\t\t//alert(foodCount);\r\n");
      out.write("\t\t\temo_food(foodCount);\r\n");
      out.write("\t\t\t$(\"img[name=foodimglist\"+foodCount+\"]\").focus();\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$('#moviePuls').click(function(){\r\n");
      out.write("\t\t\tvar movieCount=$(\"td[name=movietag]\").length;\r\n");
      out.write("\t\t\t//alert(movieCount);\r\n");
      out.write("\t\t\temo_movie(movieCount);\r\n");
      out.write("\t\t\t$(\"img[name=movieimglist\"+movieCount+\"]\").focus();\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t});\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\tfunction emo_food(number){\r\n");
      ...
      out.write("\t\tif(number>=len){\r\n");
      out.write("\t\t\talert(\"목록이 더는 없습니다.\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar br=\"\";\r\n");
      out.write("\t\tif(number>4){\r\n");
      out.write("\t\t\tbr=\"<br>\"\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfor(var i=number; i<len; i++){\r\n");
      out.write("\t\t\tvar food = foodName[i];\r\n");
      out.write("\t\t\tvar foodInfo\r\n");
      out.write("\t\t\t\t=\"<p style='text-align:left; display:inline-block';><b><span id='lineList'><span id='nameList'>\"\r\n");
      out.write("\t\t\t\t+foodName[i]+\"</span></span></b><br><br><span id='infoList'>&nbsp;1회 제공량 : \"\r\n");
      out.write("\t\t\t\t+foodOneserving[i]+\"<br>&nbsp;칼로리(100g당) : \"+foodKcal[i]+\"kcal<br>&nbsp;쓴맛/담백함 : \"\r\n");
      out.write("\t\t\t\t+foodBitterness[i]+\"/5<br>&nbsp;감칠맛 : \"\r\n");
      out.write("\t\t\t\t+foodUmami[i]+\"/5<br>&nbsp;짠맛 : \"\r\n");
      out.write("\t\t\t\t+foodSalty[i]+\"/5<br>&nbsp;단맛 : \"\r\n");
      out.write("\t\t\t\t+foodSweetness[i]+\"/5<br>&nbsp;신맛 : \"\r\n");
      out.write("\t\t\t\t+foodSourtaste[i]+\"/5</span></p>\";\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t/*var ss = \"<p><td><span id='food_wrap'>\" +\r\n");
      out.write("\t\t\t\t     \t\"<span id=food_wrapImg><a href='../review/map.ggd?food=\"+food+\"' id='foodimg' value='\"+foodName[i]+\"'>\"+\r\n");
      out.write("\t\t\t\t\t\t\t\"<img src='/img/\"+foodIndex[i]+\".jpg' id='list-img'></a></span>\"+\r\n");
      out.write("\t\t\t\t\t\t\t\"<span id='food_text'>\"+foodInfo+\"</span></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p><br>\";*/\t\r\n");
      out.write("\t\t\tvar ss = \"<td name='foodtag'><div id='image-margin'><span id='food_wrap'>\" +\r\n");
      out.write("\t\t\t\t\t     \t\"<span id=food_wrapImg><a href='../review/map.ggd?food=\"+food+\"' id='foodimg' value='\"+foodName[i]+\"'>\"+\r\n");
      out.write("\t\t\t\t\t\t\t\t\"<img src='/img/\"+foodIndex[i]+\".jpg' tabindex=0 id='list-img' name=foodimglist\"+i+\"></a></span>\"+\r\n");
      out.write("\t\t\t\t\t\t\t\t\"<span id='food_text'>\"+foodInfo+\"</span></div></td>\";\r\n");
      out.write("\t\t\t$(\"#food-list\").append(ss);\r\n");
      out.write("\t\t\tbr=\"\";\r\n");
      out.write("\t\t\tif(i>(number+3)){\r\n");
      out.write("\t\t\t$(\"#food-list\").append(\"<br>\"); \r\n");
      out.write("\t\t\t$(\"#food-list\").append(\"<br>\"); \r\n");
      out.write("\t\t\t$(\"#food-list\").append(\"<br>\"); \r\n");
      out.write("\t\t\tbreak;}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction emo_movie(number){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar movieNum='");
      out.print(movieNumData);
      out.write("';\r\n");
      ...
      out.write("';\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tmovieNum=movieNum.substring(0,movieNum.length-1).split(',');\r\n");
      ...
      out.write("\t\t\tvar oneActor=movieActor[i].split(\"|\");\r\n");
      out.write("\t\t\tif(oneActor.length>1){\r\n");
      out.write("\t\t\t\tmovieActor[i]=(oneActor[0]+\" 외 \"+oneActor.length+\"인\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tvar movieInfo=\"<p style='text-align:left; display:inline-block;'><span id='nameList'><b><a href='\"+movieLink[i]+\"' style='color:black'>\"+movieName[i]+\"</a></b></span><br><span id='lineList'><span id='infoList'>\"+movieGenre[i]+\"<br></span></span><br><span id='infoList'>&nbsp;제작년도 : \"+moviePubDate[i]+\"<br>&nbsp;감독 : \"+\r\n");
      out.write("\t\t\t\t\t\t\tmovieDirector[i].replaceAll(\"|\",\", \").substring(0,movieDirector[i].length-1)+\"<br>&nbsp;출연진 : \"+movieActor[i].replaceAll(\"|\",\", \").substring(0,movieActor[i].length)+\"<br>&nbsp;평점 : \"+movieUserRating[i]+\"</span></p>\";\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(movieImage[i]==\"\"||movieImage[i]==\"-\"){\r\n");
      out.write("\t\t\t\tmovieImage[i]=\"../noimage/noimage.gif\";\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(movieLink[i]==\"\"){\r\n");
      out.write("\t\t\t\tvar ss = \"<td id='back_image_movie' name='movietag'><div id='image-margin'><span id='movie_wrap'>\" +\r\n");
      out.write("\t\t     \t\"<span id=movie_wrapImg>\"+\r\n");
      out.write("\t\t\t\t\t\"<img src='\"+movieImage[i]+\"'id='list-img-movie' tabindex=0 name=movieimglist\"+i+\"></a></span>\"+\r\n");
      out.write("\t\t\t\t\t\"<span id=movie_text>\"+movieInfo+\"</span></div></td>\";\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t//String movieName, String movieLink ../review/map.ggd?food=\r\n");
      out.write("\t\t\t\tvar ss = \"<td id='back_image_movie' name='movietag'><div id='image-margin-movie'><span id='movie_wrap'>\" +\r\n");
      out.write("\t\t\t\t\t     \t\"<span id=movie_wrapImg><a href='../emotion/moviecount.ggd?movieNum=\"+movieNum[i]+\"&movieLink=\"+movieLink[i]+\"' >\"+\r\n");
      out.write("\t\t\t\t\t\t\t\t\"<img src='\"+movieImage[i]+\"'id='list-img-movie' tabindex=0 name=movieimglist\"+i+\"></a></span>\"+\r\n");
      out.write("\t\t\t\t\t\t\t\t\"<span id=movie_text>\"+movieInfo+\"</span></div></td>\";\t\t\t\t\t\t\r\n");
      ...
      out.write("\t<div id=\"graph\" name=\"graph\">\r\n");
      out.write("\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t<div align=\"center\" >\r\n");
      out.write("\t\t\t<h2><b>");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${seName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("</b>&nbsp;님의 감정 구성</h2>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<br><!-- \r\n");
      out.write("\t\t<div align=\"center\">\r\n");
      out.write("\t\t\t<h4>");
      ...
      out.write("\t<hr>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div id=\"food-back-img\">\r\n");
      out.write("\t\t<br>\r\n");
      out.write("\t\t<div align=\"right\">\r\n");
      out.write("\t\t\t<button type=\"button\" id=\"foodPuls\"><b style=\"font-family:'Do Hyeon', sans-serif; color:#3C5087;\">더보기</b></button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t<h2 align=center><b>오늘의 메뉴<img class=\"apple-image\" src=\"/logo/foodlogo.png\" alt=\"Applepie\" width=\"150\" height=\"80\"></b></h2>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<br>\r\n");
      out.write("\t\r\n");
      out.write("\t\t<div id=\"line2\" align=\"center\">\r\n");
      out.write("\t\t\t<br>\r\n");
      out.write("\t\t\t<ul id=\"food-list\">\r\n");
      out.write("\t\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<br>\r\n");
      out.write("\t<div id=\"movie-back-img\" name=\"movie-back-img\">\r\n");
      out.write("\t\t<div align=\"right\">\r\n");
      out.write("\t\t\t<button type=\"button\" id=\"moviePuls\"><b style=\"font-family:'Do Hyeon', sans-serif; color:#3C5087;\">더보기</b></button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t<h2 align=center><b>오늘의 영화<img class=\"apple-image\" src=\"/logo/movielogo.png\" alt=\"Applepie\" width=\"150\" height=\"80\"></b></h2>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<br>\r\n");
      out.write("\t\t<div id=\"line3\" align=\"center\">\r\n");
      out.write("\t\t\t<br>\r\n");
      out.write("\t\t\t<ul id=\"movie-list\">\r\n");
      out.write("\t\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
  ...
  private boolean _jspx_meth_spring_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/view/emotion/emotionpage.jsp(99,1) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005furl_005f0.setValue("/include/css/jqbar.css");
      // /WEB-INF/view/emotion/emotionpage.jsp(99,1) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005furl_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/view/emotion/emotionpage.jsp(100,1) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005furl_005f1.setValue("/include/js/jqbar.js");
      // /WEB-INF/view/emotion/emotionpage.jsp(100,1) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005furl_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/view/emotion/emotionpage.jsp(101,1) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005furl_005f2.setValue("/include/js/jquery.min.js");
      // /WEB-INF/view/emotion/emotionpage.jsp(101,1) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
